                        ...
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    <div class="pull-left">
                                        <h6 class="m-0 font-weight-bold text-uft">Documentos Gerencia avanzada</h6>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-4">
                                 ...
                                 <div class="col-lg-12">
                                    <div>
                                        {!! Form::open(['route'=>["estudiante.documentPost2Update",[$estudiante->id,1]],'method'=>'POST', 'class'=>'user','files'=>true,'enctype'=>'multipart/form-data']) !!}
